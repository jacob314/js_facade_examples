...
/*external num|dynamic max(List<num> array);*/
...
/*external num|dynamic max<T>(List<T> array, num accessor(T datum, num index, List<T> array));*/
/// Return the maximum value in the array using natural order and a projection function to map values to strings.
/*external String|dynamic max<T>(List<T> array, String accessor(T datum, num index, List<T> array));*/
/// Return the maximum value in the array using natural order and a projection function to map values to easily-sorted values.
/*external U|dynamic max<T, U extends Numeric>(List<T> array, U accessor(T datum, num index, List<T> array));*/
@JS()
external dynamic /*num|dynamic|String|T|U*/ max/*<T extends Numeric, U extends Numeric>*/(
    List<dynamic> /*List<num>|List<String>|List<T>*/ array,
    [Function /*Func3<T, num, List<T>, num>|Func3<T, num, List<T>, String>|Func3<T, num, List<T>, U>*/ accessor]);

/// Return the minimum value in the array using natural order.
/*external num|dynamic min(List<num> array);*/
/// Return the minimum value in the array using natural order.
/*external String|dynamic min(List<String> array);*/
/// Return the minimum value in the array using natural order.
/*external T|dynamic min<T extends Numeric>(List<T> array);*/
/// Return the minimum value in the array using natural order.
/*external num|dynamic min<T>(List<T> array, num accessor(T datum, num index, List<T> array));*/
/// Return the minimum value in the array using natural order.
/*external String|dynamic min<T>(List<T> array, String accessor(T datum, num index, List<T> array));*/
/// Return the minimum value in the array using natural order.
/*external U|dynamic min<T, U extends Numeric>(List<T> array, U accessor(T datum, num index, List<T> array));*/
@JS()
external dynamic /*num|dynamic|String|T|U*/ min/*<T extends Numeric, U extends Numeric>*/(
    List<dynamic> /*List<num>|List<String>|List<T>*/ array,
    [Function /*Func3<T, num, List<T>, num>|Func3<T, num, List<T>, String>|Func3<T, num, List<T>, U>*/ accessor]);

/// Return the min and max simultaneously.
/*external Tuple of <num,num>|Tuple of <dynamic,dynamic> extent(List<num> array);*/
/// Return the min and max simultaneously.
...
/// Return the min and max simultaneously.
/*external Tuple of <T|num|String|bool|DateTime,T|num|String|bool|DateTime>|Tuple of <dynamic,dynamic> extent<T extends Numeric>(List<T|num|String|bool|DateTime> array);*/
/// Return the min and max simultaneously.
/*external Tuple of <num,num>|Tuple of <dynamic,dynamic> extent<T>(List<T> array, num accessor(T datum, num index, List<T> array));*/
/// Return the min and max simultaneously.
/*external Tuple of <String,String>|Tuple of <dynamic,dynamic> extent<T>(List<T> array, String accessor(T datum, num index, List<T> array));*/
/// Return the min and max simultaneously.
/*external Tuple of <U|num|String|bool|DateTime,U|num|String|bool|DateTime>|Tuple of <dynamic,dynamic> extent<T, U extends Numeric>(List<T> array, U accessor(T datum, num index, List<T> array));*/
@JS()
external dynamic /*Tuple of <num,num>|Tuple of <dynamic,dynamic>|Tuple of <String,String>|Tuple of <T,T>|Tuple of <T|num|String|bool|DateTime,T|num|String|bool|DateTime>|Tuple of <U|num|String|bool|DateTime,U|num|String|bool|DateTime>*/ extent/*<T extends Numeric, U extends Numeric>*/(
    List<
        dynamic> /*List<num>|List<String>|List<T>|List<T|num|String|bool|DateTime>*/ array,
    [Function /*Func3<T, num, List<T>, num>|Func3<T, num, List<T>, String>|Func3<T, num, List<T>, U>*/ accessor]);

/// Return the mean of an array of numbers
/*external num|dynamic mean(List<num> array);*/
/*external num|dynamic mean<T>(List<T> array, num accessor(T datum, num index, List<T> array));*/
@JS()
external dynamic /*num|dynamic*/ mean/*<T>*/(
    List<dynamic> /*List<num>|List<T>*/ array,
    [num accessor(dynamic/*=T*/ datum, num index, List<dynamic/*=T*/ > array)]);

/// Return the median of an array of numbers
/*external num|dynamic median(List<num> array);*/
/*external num|dynamic median<T>(List<T> array, num accessor(T element, num i, List<T> array));*/
@JS()
external dynamic /*num|dynamic*/ median/*<T>*/(
    List<dynamic> /*List<num>|List<T>*/ array,
    [num accessor(dynamic/*=T*/ element, num i, List<dynamic/*=T*/ > array)]);

/// Returns the p-quantile of an array of numbers
/*external num|dynamic quantile(List<num> array, num p);*/
/*external num|dynamic quantile<T>(List<T> array, num p, num accessor(T element, num i, List<T> array));*/
@JS()
external dynamic /*num|dynamic*/ quantile/*<T>*/(
    List<dynamic> /*List<num>|List<T>*/ array, num p,
    [num accessor(dynamic/*=T*/ element, num i, List<dynamic/*=T*/ > array)]);

/// Compute the sum of an array of numbers.
/*external num sum(List<num> array);*/
/// Compute the sum of an array, using the given accessor to convert values to numbers.
/*external num sum<T>(List<T> array, num accessor(T datum, num index, List<T> array));*/
@JS()
...
/*external num|dynamic deviation(List<num> array);*/
...
/*external num|dynamic deviation<T>(List<T> array, num accessor(T datum, num index, List<T> array));*/
@JS()
external dynamic /*num|dynamic*/ deviation/*<T>*/(
    List<dynamic> /*List<num>|List<T>*/ array,
    [num accessor(dynamic/*=T*/ datum, num index, List<dynamic/*=T*/ > array)]);

/// Compute an unbiased estimator of the population variance of the given array of numbers.
/*external num|dynamic variance(List<num> array);*/
/// Compute an unbiased estimator of the population variance of the given array,
/// using the given accessor to convert values to numbers.
/*external num|dynamic variance<T>(List<T> array, num accessor(T datum, num index, List<T> array));*/
@JS()
external dynamic /*num|dynamic*/ variance/*<T>*/(
    List<dynamic> /*List<num>|List<T>*/ array,
    [num accessor(dynamic/*=T*/ datum, num index, List<dynamic/*=T*/ > array)]);
...
/// --------------------------------------------------------------------------------------
@JS()
external num scan/*<T>*/(List<dynamic/*=T*/ > array,
    num comparator(dynamic/*=T*/ a, dynamic/*=T*/ b));
...
external Bisector<dynamic/*=T*/, dynamic/*=U*/ > bisector/*<T, U>*/(
    Function /*Func1<T, U>|Func2<T, U, num>*/ accessor_comparator);

/// NB. this is limited to primitive values due to D3's use of the <, >, and >= operators. Results get weird for object instances.
/// Compares two primitive values for sorting (in ascending order).
@JS()
external num ascending(dynamic /*num|String|bool|DateTime*/ a,
    dynamic /*num|String|bool|DateTime*/ b);

/// NB. this is limited to primitive values due to D3's use of the <, >, and >= operators. Results get weird for object instances.
/// Compares two primitive values for sorting (in ascending order).
@JS()
external num descending(dynamic /*num|String|bool|DateTime*/ a,
    dynamic /*num|String|bool|DateTime*/ b);
