...
abstract class AxisScale<Domain> {
  external num call(Domain x);
  external List<Domain> domain();
  external List<num> range();
  external AxisScale<Domain> copy();
  external num bandwidth();
  external List /*List<num>|List<DateTime>*/ ticks(
      dynamic /*num|AxisTimeInterval*/ count);
  external dynamic /*Func1<num, String>|Func1<DateTime, String>*/ tickFormat(
      dynamic /*num|AxisTimeInterval*/ count,
      [String specifier]);
}
...
abstract class Axis<Domain> {
  ...
  /*external Func1<Domain, String>|Null tickFormat();*/
  /// Sets the tick format function and returns the axis.
  /// for display purposes.
  /*external Axis tickFormat(String format(Domain domainValue));*/
  ...
  external dynamic /*Func1<Domain, String>|Axis*/ tickFormat(
      [String format(Domain domainValue)]);
